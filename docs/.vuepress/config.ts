    ...
    locales: {
      '/': {
        ...
        navbar: [
          ...
          { text: '相关链接', children: [ {text: '服务器封禁列表', link: 'https://Bans.RSerene.com/'}, {text: 'GitHub', link: 'https://GitHub.com/Rain-Serenity/'}, {text: 'MCBBS纪念版', link: 'https://www.MCBBS.co/thread-5031-1-1.html'}, {text: 'MineBBS', link: 'https://www.MineBBS.com/threads/1-21-1.28390/'}, {text: 'Minecraft Wiki', link: 'https://Minecraft.Wiki/'}, {text: 'NameMC', link: 'https://NameMC.com/server/play.rserene.com'}, {text: '苦力怕论坛', link: 'https://KLPBBS.com/thread-171662-1-1.html'} ]}
        ],
        bulletin: {
          body: [
            {
      ...
      '/zh-tw/': {
        ...
        navbar: [
          ...
          { text: '相關連結', children: [ {text: '伺服器封禁列表', link: 'https://Bans.RSerene.com/'}, {text: 'GitHub', link: 'https://GitHub.com/Rain-Serenity/'}, {text: 'MCBBS紀念版', link: 'https://www.MCBBS.co/thread-5031-1-1.html'}, {text: 'MineBBS', link: 'https://www.MineBBS.com/threads/1-21-1.28390/'}, {text: 'Minecraft Wiki', link: 'https://Minecraft.Wiki/'}, {text: 'NameMC', link: 'https://NameMC.com/server/play.rserene.com'}, {text: '苦力怕論壇', link: 'https://KLPBBS.com/thread-171662-1-1.html'} ]}
        ],
        bulletin: {
          body: [
            {
      ...
      '/en-us/': {
        ...
        navbar: [
          ...
          { text: 'Related Links', children: [ {text: 'Ban List', link: 'https://Bans.RSerene.com/'}, {text: 'GitHub', link: 'https://GitHub.com/Rain-Serenity/'}, {text: 'MCBBS Memorial', link: 'https://www.MCBBS.co/thread-5031-1-1.html'}, {text: 'MineBBS', link: 'https://www.MineBBS.com/threads/1-21-1.28390/'}, {text: 'Minecraft Wiki', link: 'https://Minecraft.Wiki/'}, {text: 'NameMC', link: 'https://NameMC.com/server/play.rserene.com'}, {text: 'KLPBBS', link: 'https://KLPBBS.com/thread-171662-1-1.html'} ]}
        ],
        bulletin: {
          body: [
            {
      ...
      '/ru-ru/': {
        ...
        navbar: [
          ...
          { text: 'Ссылки', children: [ {text: 'Список банов', link: 'https://Bans.RSerene.com/'}, {text: 'GitHub', link: 'https://GitHub.com/Rain-Serenity/'}, {text: 'MCBBS Memorial', link: 'https://www.MCBBS.co/thread-5031-1-1.html'}, {text: 'MineBBS', link: 'https://www.MineBBS.com/threads/1-21-1.28390/'}, {text: 'Minecraft Wiki', link: 'https://Minecraft.Wiki/'}, {text: 'NameMC', link: 'https://NameMC.com/server/play.rserene.com'}, {text: 'KLPBBS', link: 'https://KLPBBS.com/thread-171662-1-1.html'} ]}
        ],
        bulletin: {
          body: [
            {
      ...
      '/ja-jp/': {
        ...
        navbar: [
          ...
          { text: '関連リンク', children: [ {text: 'BANリスト', link: 'https://Bans.RSerene.com/'}, {text: 'GitHub', link: 'https://GitHub.com/Rain-Serenity/'}, {text: 'MCBBS Memorial', link: 'https://www.MCBBS.co/thread-5031-1-1.html'}, {text: 'MineBBS', link: 'https://www.MineBBS.com/threads/1-21-1.28390/'}, {text: 'Minecraft Wiki', link: 'https://Minecraft.Wiki/'}, {text: 'NameMC', link: 'https://NameMC.com/server/play.rserene.com'}, {text: 'KLPBBS', link: 'https://KLPBBS.com/thread-171662-1-1.html'} ]}
        ],
        bulletin: {
          body: [
            {
      ...
      '/ko-kr/': {
        ...
        navbar: [
          ...
          { text: '관련 링크', children: [ {text: '밴 목록', link: 'https://Bans.RSerene.com/'}, {text: 'GitHub', link: 'https://GitHub.com/Rain-Serenity/'}, {text: 'MCBBS Memorial', link: 'https://www.MCBBS.co/thread-5031-1-1.html'}, {text: 'MineBBS', link: 'https://www.MineBBS.com/threads/1-21-1.28390/'}, {text: 'Minecraft Wiki', link: 'https://Minecraft.Wiki/'}, {text: 'NameMC', link: 'https://NameMC.com/server/play.rserene.com'}, {text: 'KLPBBS', link: 'https://KLPBBS.com/thread-171662-1-1.html'} ]}
        ],
        bulletin: {
          body: [
            {
